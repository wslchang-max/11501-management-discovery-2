...
# Extract json array by finding first '[' after slidesData and matching closing ']'
start_pos = text.find('const slidesData = [') + len('const slidesData = ')
# Find matching closing bracket for slidesData
open_brackets = 0
end_pos = -1
...
if end_pos != -1:
    slides_json = text[start_pos:end_pos]
    slides = json.loads(slides_json)
    print("Parsed", len(slides), "slides successfully!")
else:
...
print("HTML files updated cleanly and completely!")
