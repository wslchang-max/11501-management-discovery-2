...
# Read git_tracked_files.txt to get the exact git tracked filenames
with open("git_tracked_files.txt", "r", encoding="utf-8") as f:
    files = [line.strip() for line in f if line.strip()]

html_files = [f for f in files if f.endswith(".html") and f not in ["index.html", "整合18週課程平台.html"]]
docx_files = [f for f in files if f.endswith(".docx") and f.startswith("第")]
...
for w in range(1, 19):
    pref = prefix_map[w]
    matching_html = [h for h in html_files if h.startswith(pref)]
    matching_docx = [d for d in docx_files if d.startswith(pref)]
    
    html_name = matching_html[0] if matching_html else None
    docx_name = matching_docx[0] if matching_docx else None
    
    weeks_exact[w] = {
        "html": html_name,
        "docx": docx_name
    }
    print(f"W{w:02d}: HTML={html_name}")
    print(f"     DOCX={docx_name}")

# Now build index.html using the exact git tracked filenames
weeks_metadata = [
    {
        "w": 1, "mod": "mod1", "icon": "fa-flag",
        "zh_t": "第一週：資訊爆炸時代的財經素養",
        "en_t": "Week 1: Financial Literacy in the Information Age",
        "zh_d": "在新聞與網紅雜訊中辨識真實訊號！學習信噪比 (SNR) 計算、新聞標題重組與雜訊偵測遊戲。",
        "en_d": "Filter market noise from real signals. Learn Signal-to-Noise Ratio (SNR) calculation, headline audits & noise games.",
        "tags": ["SNR Calculation", "30 Slides", "Noise Audit"],
        "search": "W1 資訊爆炸 財經素養 信噪比 SNR 計算 標題重組 雜訊偵測 Financial Literacy SNR"
    },
    {
        "w": 2, "mod": "mod1", "icon": "fa-chart-area",
        "zh_t": "第二週：物價通膨與實質購買力",
        "en_t": "Week 2: Inflation & Real Purchasing Power",
        "zh_d": "看不懂經濟指標就無法理財！解讀 GDP、CPI、失業率、央行升降息與國發會景氣燈號。",
        "en_d": "Mastering macroeconomic indicators: GDP, CPI, Interest Rates, Unemployment & Economic Climate Lights.",
        "tags": ["GDP & CPI", "Interest Rates", "Climate Lights"],
        "search": "W2 理財時代 經濟指標 GDP CPI 失業率 央行升降息 景氣燈號 Macroeconomics GDP CPI 物價通膨"
    },
    {
        "w": 3, "mod": "mod1", "icon": "fa-scale-unbalanced",
        "zh_t": "第三週：利率央行貨幣政策與資產價格",
        "en_t": "Week 3: Interest Rates, Central Banks & Asset Prices",
        "zh_d": "錢放在銀行為什麼越存越小？計算通膨對購買力的侵蝕，掌握名目利率 vs 實質利率與 72 法則。",
        "en_d": "Why cash savings shrink over time. Calculating inflation's erosion on purchasing power & the Rule of 72.",
        "tags": ["Inflation Erosion", "Rule of 72", "Real Interest"],
        "search": "W3 通貨膨脹 購買力 實質利率 72法則 實質所得 Inflation Purchasing Power 央行貨幣政策"
    },
    {
        "w": 4, "mod": "mod1", "icon": "fa-arrow-trend-up",
        "zh_t": "第四週：股市入門與企業價值估算",
        "en_t": "Week 4: Stock Market Basics & Corporate Valuation",
        "zh_d": "大一新鮮人第一堂股票課！看懂 K 線圖、本益比 (P/E Ratio)、殖利率與企業價值估算技巧。",
        "en_d": "First stock market class for freshmen. Understanding Candlesticks, P/E Ratios & Corporate Valuation.",
        "tags": ["P/E Ratio", "Dividend Yield", "Valuation"],
        "search": "W4 股市入門 本益比 PE 企業估值 股利本益比 投資組合 Stock Valuation PE"
    },
    {
        "w": 5, "mod": "mod2", "icon": "fa-cubes",
        "zh_t": "第五週：ETF狂熱：主動型ETF與被動投資",
        "en_t": "Week 5: ETF Mania: Active & Passive ETF Strategies",
        "zh_d": "全台最熱門投資工具！拆解 ETF 運作機制、高股息 vs 市值型、主動型 ETF 與總費用率 (TER)。",
        "en_d": "Taiwan's most popular investment vehicle! Active vs Passive ETFs, High-Dividend funds & Expense Ratios.",
        "tags": ["Active vs Passive", "Expense Ratio", "High Dividend"],
        "search": "W5 ETF 狂熱 主動型ETF 被動投資 指數追蹤 費用率 Active Passive ETF"
    },
    {
        "w": 6, "mod": "mod2", "icon": "fa-building-columns",
        "zh_t": "第六週：數位金融：高利活存與銀行業變革",
        "en_t": "Week 6: Digital Banking & High-Yield Savings Accounts",
        "zh_d": "新鮮人必備數位帳戶指南！解析高利活存優惠上限、純網銀 vs 傳統銀行數位帳戶優惠。",
        "en_d": "Freshman guide to digital banking: High-yield savings caps, Neobanks vs Traditional Banks.",
        "tags": ["High-Yield Savings", "Neobanks", "Digital Accounts"],
        "search": "W6 數位金融 高利活存 純網行 數位帳戶 銀行業變革 Digital Banking Savings"
    },
    {
        "w": 7, "mod": "mod2", "icon": "fa-globe",
        "zh_t": "第七週：個人外匯匯率變動與國際貿易",
        "en_t": "Week 7: Foreign Exchange Rates & Global Trade",
        "zh_d": "了解匯率波動對個人理財與海外消費的影響！解讀美元指數、利差交易與個人外匯避險工具。",
        "en_d": "Understanding foreign exchange impacts on personal wealth: USD index, interest rate arbitrage & FX hedging.",
        "tags": ["FX Rates", "USD Index", "Global Trade"],
        "search": "W7 外匯 匯率 國際貿易 美元指數 利差交易 Foreign Exchange Global Trade FX"
    },
    {
        "w": 8, "mod": "mod2", "icon": "fa-clipboard-check",
        "zh_t": "第八週：期中學習成果檢核與實戰個案總複習",
        "en_t": "Week 8: Midterm Assessment & Practical Case Studies",
        "zh_d": "前半學期觀念整合大考驗！小組實戰個案診斷、通爆/股票/ETF/信用盲點檢視與反思。",
        "en_d": "Midterm integration challenge! Group case diagnoses reviewing inflation, stocks, ETFs & credit pitfalls.",
        "tags": ["Midterm Review", "Case Diagnosis", "Synthesis"],
        "search": "W8 期中檢核 實戰個案 總複習 財經複習 觀念測驗 Midterm Review Case"
    },
    {
        "w": 9, "mod": "mod3", "icon": "fa-shield-halved",
        "zh_t": "第九週：保險基礎風險管理與個人保障規劃",
        "en_t": "Week 9: Insurance Fundamentals & Personal Risk Protection",
        "zh_d": "建構財務安全的護城河！解析保險三大功能、人壽/醫療/實支實付理賠與大一保單規劃。",
        "en_d": "Building your financial moat: Insurance fundamentals, health coverage & risk planning.",
        "tags": ["Insurance Basics", "Risk Protection", "Policy Planning"],
        "search": "W9 保險基礎 風險管理 個人保障規劃 人壽保險 實支實付 健康險 Insurance Risk"
    },
    {
        "w": 10, "mod": "mod3", "icon": "fa-house",
        "zh_t": "第十週：不動產房地產與租買決策財務學",
        "en_t": "Week 10: Real Estate: Rent vs. Buy Decision Financials",
        "zh_d": "年輕人到底該買房還是租房？計算房貸負擔率、租金回報率、頭期款籌措與機會成本。",
        "en_d": "Rent vs Buy decision framework: Mortgage affordability, rental yields, down payments & opportunity costs.",
        "tags": ["Rent vs Buy", "Mortgage Affordability", "Yield Rates"],
        "search": "W10 不動產 房地產 租買決策 房貸試算 房價負擔能力 租金回報率 Real Estate Rent Buy"
    },
    {
        "w": 11, "mod": "mod3", "icon": "fa-file-invoice-dollar",
        "zh_t": "第十一週：個人綜合所得稅節稅規劃與報稅實務",
        "en_t": "Week 11: Personal Income Tax Planning & Tax Filing",
        "zh_d": "社會新人必修第一堂課！理解綜合所得稅計算、免稅額/標準扣除額/特別扣除額與合法節稅。",
        "en_d": "First tax class for grads: Income tax tiers, exemptions, standard vs itemized deductions.",
        "tags": ["Income Tax Tiers", "Deductions", "Tax Saving"],
        "search": "W11 所得稅 節稅 報稅 免稅額 扣除額 稅率級距 Income Tax Filing"
    },
    {
        "w": 12, "mod": "mod3", "icon": "fa-receipt",
        "zh_t": "第十二週：個人與家庭資產負債表、現金流管理與生涯理財規劃",
        "en_t": "Week 12: Personal Balance Sheets & Life-Cycle Financial Planning",
        "zh_d": "建立個人專屬的財務報表！編製個人資產負債表、追蹤自由現金流與 20-30-40 生涯理財比例。",
        "en_d": "Building your financial statement: Personal Balance Sheets, Cash Flow tracking & budget ratios.",
        "tags": ["Balance Sheet", "Cash Flow", "Budget Allocation"],
        "search": "W12 資產負債表 現金流 生涯理財 淨資產 記帳管理 Balance Sheet Cash Flow"
    },
    {
        "w": 13, "mod": "mod4", "icon": "fa-microchip",
        "zh_t": "第十三週：半導體產業護國神山台積電與台灣科技供應鏈",
        "en_t": "Week 13: Semiconductor Industry, TSMC & Tech Supply Chains",
        "zh_d": "深入剖析護國神山台積電！晶圓代工商業模式、半導體上中下游產業鏈與全球競爭優勢。",
        "en_d": "Deep dive into TSMC: Foundry business model, semiconductor supply chain & global advantages.",
        "tags": ["TSMC Foundry", "Supply Chain", "Semiconductors"],
        "search": "W13 半導體 台積電 TSMC 科技供應鏈 晶圓代工 護國神山 Semiconductor TSMC"
    },
    {
        "w": 14, "mod": "mod4", "icon": "fa-robot",
        "zh_t": "第十四週：生成式AI革命、人工智慧產業鏈與未來職場轉型",
        "en_t": "Week 14: Generative AI Revolution & Workplace Transformation",
        "zh_d": "AI 如何改變未來的職場與產業？分析生成式 AI 工具、算力經濟、Nvidia 與新鮮人關鍵能力。",
        "en_d": "How AI rewrites the workplace: Generative AI tools, compute economics, Nvidia & career skills.",
    ...
    {
        "w": 15, "mod": "mod4", "icon": "fa-leaf",
        "zh_t": "第十五週：綠色金融、ESG永續投資與碳定價經濟學",
        "en_t": "Week 15: Green Finance, ESG Investing & Carbon Pricing",
        "zh_d": "永續經濟學的核心大趨勢！綠色金融商品、ESG 評級投資法、碳權交易與碳定價對企業的影響。",
        "en_d": "Green economy trends: Green finance, ESG rating strategies, carbon trading & carbon pricing impacts.",
        "tags": ["Green Finance", "ESG Ratings", "Carbon Pricing"],
        "search": "W15 綠色金融 ESG 永續投資 碳定價 碳交易 CBAM Green Finance ESG"
    },
    {
        "w": 16, "mod": "mod4", "icon": "fa-link",
        "zh_t": "第十六週：加密貨幣、區塊鏈基礎Web3與數位資產風險",
        "en_t": "Week 16: Cryptocurrencies, Blockchain Web3 & Digital Asset Risks",
        "zh_d": "正視新世代數位資產風險！區塊鏈去中心化原理、加密貨幣波動性、Web3 應用與詐騙防範。",
        "en_d": "Navigating digital assets: Blockchain decentralization, crypto volatility, Web3 & fraud prevention.",
        "tags": ["Blockchain & Web3", "Crypto Risk", "Fraud Prevention"],
        "search": "W16 加密貨幣 區塊鏈 Web3 數位資產 比特幣 詐騙防範 Crypto Blockchain Web3"
    },
    {
        "w": 17, "mod": "mod4", "icon": "fa-chalkboard-user",
        "zh_t": "第十七週：期末專案發表實戰財經簡報與總評量",
        "en_t": "Week 17: Final Project Capstone Presentations & Pitching",
        "zh_d": "大一新鮮人的第一次實戰 Pitch！小組報告財經與理財專案、專業簡報架構與同儕互評。",
        "en_d": "Freshman Capstone Pitch! Group presentations on financial topics, feedback & peer reviews.",
        "tags": ["Capstone Pitch", "Presentation Skills", "Peer Review"],
        "search": "W17 期末專案 簡報發表 實戰 Pitch 評分量表 簡報技巧 Capstone Pitch"
    },
    {
        "w": 18, "mod": "mod4", "icon": "fa-trophy",
        "zh_t": "第十八週：學期總結財經探索藍圖與大一新鮮人終身宣言",
        "en_t": "Week 18: Semester Synthesis & Freshman Lifelong Manifesto",
        "zh_d": "18 週財經探索大結業！繪製個人大學 4 年理財藍圖、簽署終身理財宣言與頒發結業證明。",
        "en_d": "Grand Graduation! Drawing 4-year personal financial roadmaps, signing Lifelong Manifestos.",
        "tags": ["Grand Graduation", "4-Year Roadmap", "Lifelong Manifesto"],
        "search": "W18 大結業 探索藍圖 終身宣言 理財地圖 新鮮人宣言 Graduation Roadmap"
    }
]

# Attach exact filenames
for m in weeks_metadata:
    w = m["w"]
    m["html_file"] = weeks_exact[w]["html"]
    m["docx_file"] = weeks_exact[w]["docx"]
        ...
        cards_html_buffer.append(f"""
                ...
                <div class="week-card" data-tags="{item['search']}">
                    <div class="card-top">
                        ...
                        <h3 class="card-title">
                            <span class="lang-zh">{item['zh_t']}</span>
                            <span class="lang-en">{item['en_t']}</span>
                        </h3>
                        <p class="card-desc">
                            <span class="lang-zh">{item['zh_d']}</span>
                            <span class="lang-en">{item['en_d']}</span>
                        </p>
                        <div class="tags-list">
                            {tags_rendered}
                        </div>
...
print("SUCCESS: index.html has been generated with 100% EXACT tracked Git filenames!")
