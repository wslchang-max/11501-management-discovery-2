...
def build_simplified_w3_app_js():
    # 30 pure slides designed specifically for Freshman Non-Finance Students
    slides = [
        # SLIDE 1
        {
            "id": 1, "hour": 1, "tag": {"zh": "單元導論", "en": "Introduction"},
            "title": {"zh": "Slide 01 | 第三週課程導論：利率、央行與我們的荷包", "en": "Slide 01 | Introduction: Interest Rates, Central Banks & Your Wallet"},
        ...
        # SLIDE 2
        {
            "id": 2, "hour": 1, "tag": {"zh": "學習地圖", "en": "Roadmap"},
            "title": {"zh": "Slide 02 | 第二週 3 小時生活化學習地圖", "en": "Slide 02 | 3-Hour Practical Learning Roadmap"},
            "content": {
                "zh": """
        ...
        # SLIDE 3
        {
            "id": 3, "hour": 1, "tag": {"zh": "生活體驗", "en": "Life Experience"},
            "title": {"zh": "Slide 03 | 生活體驗：學貸、買車分期與房貸每個月差多少？", "en": "Slide 03 | Daily Experience: Loans & Monthly Payments"},
            "content": {
                "zh": """
        ...
        # SLIDE 4
        {
            "id": 4, "hour": 1, "tag": {"zh": "白話利率", "en": "What is Rate?"},
            "title": {"zh": "Slide 04 | 白話文：什麼是「利率」？借錢的租金與存錢的報酬", "en": "Slide 04 | In Plain English: What is an Interest Rate?"},
            "content": {
                "zh": """
        ...
        # SLIDE 5
        {
            "id": 5, "hour": 1, "tag": {"zh": "新聞解密", "en": "Headline Decoding"},
            "title": {"zh": "Slide 05 | 新聞解密：什麼是「升息一碼」、「半碼」？", "en": "Slide 05 | News Decoding: What is a 'Basis Point'?"},
            "content": {
                "zh": """
                ...
                """,
                "en": """
                    <p>Financial news often says "Central bank raised rates by 1码 (25 bps)". What does it mean?</p>
                    <div class="slide-grid">
                        <div class="slide-card-box">
        ...
        # SLIDE 6
        {
            "id": 6, "hour": 1, "tag": {"zh": "高利活存陷阱", "en": "Digital Bank Trap"},
            "title": {"zh": "Slide 06 | 數位帳戶「3% 高利活存」是真的嗎？條款大揭密", "en": "Slide 06 | Are '3% High-Yield Digital Accounts' Real?"},
            "content": {
                "zh": """
                    <p>很多大學生會被廣告吸「數位帳戶年利率 3% 活存」，真的有這麼好康嗎？</p>
                    <div class="slide-grid">
                        <div class="slide-card-box">
        ...
        # SLIDE 7
        {
            "id": 7, "hour": 1, "tag": {"zh": "刷卡分期陷阱", "en": "0% Installment Trap"},
            "title": {"zh": "Slide 07 | 零利率分期付款真的免費嗎？手續費換算真實利率", "en": "Slide 07 | Is '0% Credit Card Installment' Free?"},
            "content": {
                "zh": """
        ...
        # SLIDE 8
        {
            "id": 8, "hour": 1, "tag": {"zh": "第一筆理財", "en": "First $100k Savings"},
            "title": {"zh": "Slide 08 | 大學生第一筆 10 萬元存款該怎麼擺才不吃虧？", "en": "Slide 08 | How Students Should Store Their First $100k Savings"},
            "content": {
                "zh": """
        ...
        # SLIDE 9
        {
            "id": 9, "hour": 1, "tag": {"zh": "生活討論", "en": "Class Discussion"},
            "title": {"zh": "Slide 09 | 課堂討論：央行升息會讓房東調漲我們的房租嗎？", "en": "Slide 09 | Class Discussion: Do Rate Hikes Cause Rent Surges?"},
            "content": {
                "zh": """
        ...
        # SLIDE 10
        {
            "id": 10, "hour": 1, "tag": {"zh": "第一小時活動", "en": "Hour 1 Activity"},
        ...
        # SLIDE 11
        {
            "id": 11, "hour": 2, "tag": {"zh": "唯一學術觀念", "en": "Core Theory"},
            "title": {"zh": "Slide 11 | 本週唯一核心觀念：金錢的時間價值 (Time Value of Money)", "en": "Slide 11 | Week 3 Only Core Concept: Time Value of Money"},
            "content": {
                "zh": """
        ...
        # SLIDE 12
        {
            "id": 12, "hour": 2, "tag": {"zh": "時事討論", "en": "Current Events"},
            "title": {"zh": "Slide 12 | 新聞時事：台灣央行總裁開會「升息打房」有效嗎？", "en": "Slide 12 | News Debate: Does Central Bank Rate Hiking Curb House Prices?"},
        ...
        # SLIDE 13
        {
            "id": 13, "hour": 2, "tag": {"zh": "美聯儲 Fed", "en": "US Fed Impact"},
            "title": {"zh": "Slide 13 | 新聞時事：美國阿伯開會降息，為什麼全球股市大暴動？", "en": "Slide 13 | News Debate: Why Does the US Fed Control Global Markets?"},
            "content": {
                "zh": """
        ...
        # SLIDE 14
        {
            "id": 14, "hour": 2, "tag": {"zh": "科技股暴跌", "en": "Tech Stocks"},
            "title": {"zh": "Slide 14 | 為什麼升息時，新聞常寫「科技股大暴跌」？", "en": "Slide 14 | Why Do Rate Hikes Cause Tech Stock Sell-Offs?"},
            "content": {
                "zh": """
        ...
        # SLIDE 15
        {
            "id": 15, "hour": 2, "tag": {"zh": "銀行股利多", "en": "Bank Stocks"},
            "title": {"zh": "Slide 15 | 為什麼升息對銀行股反而是好消息？", "en": "Slide 15 | Why Are Rate Hikes Good News for Banks?"},
            "content": {
                "zh": """
        ...
        # SLIDE 16
        {
            "id": 16, "hour": 2, "tag": {"zh": "消費陷阱", "en": "Consumer Traps"},
            "title": {"zh": "Slide 16 | 生活實戰：信用卡「預支現金」與「循環利息」噩夢", "en": "Slide 16 | Life Practice: Credit Card Revolving Interest Nightmares"},
            "content": {
                "zh": """
        ...
        # SLIDE 17
        {
            "id": 17, "hour": 2, "tag": {"zh": "買房 vs 租房", "en": "Rent vs Buy"},
            "title": {"zh": "Slide 17 | 理財情境思考：高利率時代，買房還是租房划算？", "en": "Slide 17 | Practical Thinking: Rent or Buy in High Rate Eras?"},
            "content": {
                "zh": """
        ...
        # SLIDE 18
        {
            "id": 18, "hour": 2, "tag": {"zh": "防詐理財", "en": "Scam Prevention"},
            "title": {"zh": "Slide 18 | 防詐警訊：宣稱「月報酬 10% 零風險」的必定是詐騙！", "en": "Slide 18 | Scam Alert: Anything Promising '10% Monthly Zero Risk' is Fake!"},
            "content": {
                "zh": """
        ...
        # SLIDE 19
        {
            "id": 19, "hour": 2, "tag": {"zh": "實用理財規則", "en": "Practical Rules"},
            "title": {"zh": "Slide 19 | 大學生個人利率理財 3 大黃金法則", "en": "Slide 19 | 3 Golden Rules of Interest Rates for College Students"},
            "content": {
                "zh": """
        ...
        # SLIDE 21
        {
            "id": 21, "hour": 3, "tag": {"zh": "白話債券", "en": "Bonds Made Simple"},
            "title": {"zh": "Slide 21 | 新聞說的「債券殖利率」到底是什麼？白話文大解密", "en": "Slide 21 | Plain English: What is 'Bond Yield'?"},
        ...
        # SLIDE 22
        {
            "id": 22, "hour": 3, "tag": {"zh": "價格與殖利率", "en": "Price vs Yield"},
            "title": {"zh": "Slide 22 | 為什麼新聞說「利率上升，債券價格下跌」？", "en": "Slide 22 | Why Do Bond Prices Fall When Rates Rise?"},
            "content": {
                "zh": """
        ...
        # SLIDE 23
        {
            "id": 23, "hour": 3, "tag": {"zh": "軟著陸與硬著陸", "en": "Soft vs Hard Landing"},
            "title": {"zh": "Slide 23 | 新聞用語解密：什麼是經濟「軟著陸」與「硬著陸」？", "en": "Slide 23 | News Terms: What is 'Soft Landing' vs 'Hard Landing'?"},
            "content": {
                "zh": """
        ...
        # SLIDE 24
        {
            "id": 24, "hour": 3, "tag": {"zh": "第一筆理財計畫", "en": "First Plan"},
            "title": {"zh": "Slide 24 | 大學生如何建立第一個抗通膨與利率風險理財計畫？", "en": "Slide 24 | Building Your First Anti-Inflation Financial Plan"},
            "content": {
                "zh": """
        ...
        # SLIDE 25
        {
            "id": 25, "hour": 3, "tag": {"zh": "理財傻事", "en": "Mistakes to Avoid"},
            "title": {"zh": "Slide 25 | 升息時代大學生絕對不能做的 3 個理財傻事", "en": "Slide 25 | 3 Financial Mistakes College Students Must Avoid"},
            "content": {
                "zh": """
        ...
        # SLIDE 26
        {
            "id": 26, "hour": 3, "tag": {"zh": "新聞閱讀練習", "en": "News Reading"},
            "title": {"zh": "Slide 26 | 實務演練：看懂今日財經新聞的三個步驟", "en": "Slide 26 | Practice: 3 Steps to Read Any Financial News Headline"},
            "content": {
                "zh": """
        ...
        # SLIDE 27
        {
            "id": 27, "hour": 3, "tag": {"zh": "理財心法", "en": "Financial Wisdom"},
            "title": {"zh": "Slide 27 | 理財心法：先理健康腦，再理口袋錢", "en": "Slide 27 | Financial Wisdom: Train Your Brain Before Your Money"},
            "content": {
                "zh": """
        ...
        # SLIDE 28
        {
            "id": 28, "hour": 3, "tag": {"zh": "第三週總結", "en": "Week 3 Summary"},
            "title": {"zh": "Slide 28 | 第三週全景生活化觀念總整理", "en": "Slide 28 | Week 3 Practical Concept Summary"},
            "content": {
                "zh": """
                    <p>第三週核心觀念快速複習：</p>
                    <div class="slide-grid">
        ...
        # SLIDE 29
        {
            "id": 29, "hour": 3, "tag": {"zh": "課後作業", "en": "Homework Assignment"},
            "title": {"zh": "Slide 29 | 本週課後作業說明：央行新聞閱讀與個人存款計畫", "en": "Slide 29 | Homework Guide: News Reading & Student Savings Plan"},
            "content": {
                "zh": """
                    <p>請前往雙語網頁完成本週實務作業：</p>
                    <div class="slide-grid">
        ...
        # SLIDE 30
        {
            "id": 30, "hour": 3, "tag": {"zh": "第四週預告", "en": "Next Week Preview"},
            "title": {"zh": "Slide 30 | 學習反思與第四週預告 (股票市場基礎與如何挑選第一支股票)", "en": "Slide 30 | Reflection & Next Week Preview (Stock Fundamentals & Buying Your First Stock)"},
            "content": {
                "zh": """
    ...
    js_content = f"""// 115管理探索二 第三週：利率、央行與我們的荷包 (大一非財金素養生活化版)
...
const w3GameQuestions = [
  {{
    ...
    news_zh: "『央行理監事會議宣佈「升息一碼」，請問銀行利息調高了多少百分比？』", news_en: "'Central Bank announced 1 码 rate hike. How much is it in %?'",
    options_zh: ["0.25%", "1.00%"], options_en: ["0.25%", "1.00%"],
    answer: 0, explain_zh: "正確！一碼就是 0.25%，半碼就是 0.125%。", explain_en: "Correct! 1 quarter point (码) equals 0.25%."
  }},
  {{
  ...
  {{
    ...
    options_zh: ["這必定是龐氏騙局詐騙！連美國國債年利率也才 4% 左右", "趕快把學貸和積蓄通通投入"], options_en: ["It's 100% a Ponzi fraud! Even US Treasuries offer only ~4% yearly", "Invest student savings immediately"],
...
"""
    ...
    print("Rebuilt simplified w3_app.js successfully!")

if __name__ == '__main__':
    build_simplified_w3_app_js()
